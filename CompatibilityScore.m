function CS=CompatibilityScore(inputfile,couplings,localfields,Htype)
...
%
%	OUTPUT:
%		CS 	    - Vector of the Compatibility Scores of each sequences.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    InterPairs=load('LacI family residue pairs with top 1500 DI values.txt');
            ...
            %Compute across 2 different modules
              for seq=1:M
                  for res=1:length(InterPairs)
                      ...
                      CS(seq)=couplings(iindex,jindex)+CS(seq); 
                  end                                       
              end
        case 2
